...
import { ArrowRightIcon, SearchIcon, UserPlusIcon, UsersIcon, GraduationCapIcon, Loader2, ShirtIcon, ShoppingBagIcon } from 'lucide-react';
...
const features = [
  ...
  {
    icon: <ShirtIcon className="h-8 w-8 text-primary mb-4" />,
    title: "Laundry Services",
    description: "Professional laundry services with pickup and delivery. Keep your clothes clean and fresh.",
    link: "/laundry",
    linkLabel: "Book Laundry"
  },
  {
    icon: <ShoppingBagIcon className="h-8 w-8 text-primary mb-4" />,
    title: "Second-Hand Marketplace",
    description: "Buy and sell second-hand items within the university community. Great deals on furniture, electronics, and more.",
    link: "/marketplace",
...
// Temporarily using mock data until Firebase is properly configured
  ...
  return [
    {
      ...
      address: 'Near Meru University Campus',
      price: 15000,
      bedrooms: 1,
      bathrooms: 1,
      ...
      agent: { name: 'John Doe', phone: '0700 000 000' },
      createdAt: new Date(),
    },
    {
      id: '2',
      name: 'Shared House Room',
      address: 'Kianjai Road',
      price: 8000,
      bedrooms: 1,
      bathrooms: 1,
      imageUrl: 'https://placehold.co/400x300.png',
      description: 'Comfortable room in a shared house.',
      amenities: ['WiFi', 'Kitchen', 'Laundry'],
      agent: { name: 'Jane Smith', phone: '0700 000 001' },
      createdAt: new Date(),
    },
    {
      id: '3',
      name: 'Furnished Apartment',
      address: 'California Estate',
      price: 20000,
      bedrooms: 2,
      bathrooms: 2,
      imageUrl: 'https://placehold.co/400x300.png',
      ...
      agent: { name: 'Mike Johnson', phone: '0700 000 002' },
      createdAt: new Date(),
    }
  ];
}
...
export default function HomePage() {
  ...
  // Temporarily commented out Firebase auth until properly configured
  // useEffect(() => {
      ...
      <section className="py-20 md:py-32 bg-gradient-to-br from-primary/10 via-background to-background">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="space-x-4">
            ...
            {/* Temporarily showing signup button until Firebase auth is configured */}
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          ...
          <p className="text-muted-foreground text-center mb-12 max-w-xl mx-auto">
            We are dedicated to providing a seamless and trustworthy platform for your housing, laundry, and marketplace needs.
          </p>
            ...
            {features.map((feature) => (
              <Card key={feature.title} className="shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <CardContent className="text-center">
                  ...
                  {/* Temporarily showing all feature links until Firebase auth is configured */}
