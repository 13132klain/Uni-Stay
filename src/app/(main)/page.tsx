...
const features = [
  ...
  },
  {
    ...
    title: "Laundry Services (New!)",
    description: "Professional laundry services designed for students. Quick, clean, and convenient solutions for your laundry needs.",
    link: "/laundry",
    linkLabel: "Book Laundry"
  },
  {
    icon: <ShoppingBagIcon className="h-8 w-8 text-primary mb-4" />,
    title: "Student Marketplace (New!)",
    description: "Buy and sell second-hand items with fellow students. Find great deals on textbooks, electronics, and more!",
    link: "/market",
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          ...
          <p className="text-muted-foreground text-center mb-12 max-w-xl mx-auto">
            We are dedicated to providing a comprehensive platform for all your student needs - from housing to laundry services and marketplace.
          </p>
