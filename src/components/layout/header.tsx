...
import { MenuIcon, HomeIcon, ListIcon, UsersIcon, LifeBuoyIcon, UserPlusIcon, LogInIcon, LogOutIcon, UserCircle, CogIcon, ShieldCheckIcon, HeartIcon, Settings2Icon, Building2Icon, ShirtIcon, ShoppingBagIcon } from 'lucide-react'; // Added Building2Icon, ShirtIcon, ShoppingBagIcon
...
const navItems = [
  ...
  { href: '/market', label: 'Marketplace', icon: ShoppingBagIcon },
